      ...
      while (requesting) {
        ...
        switch(choice) {
          ...
          case 4:
            ...
            break;
          case 5:
            System.out.println("Which task would you pick?(1 - add, 2 - view, 3 - buy):");
            // This is the inventory task choice
            ...
            switch (task) {
              case "add":
                ...
                System.out.println("How many quanities: ");
